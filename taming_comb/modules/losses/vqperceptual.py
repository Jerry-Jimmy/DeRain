...
from taming_comb.modules.losses.lpips import LPIPS
from taming_comb.modules.discriminator.model import NLayerDiscriminator, weights_init
...
#        self.disc_conditional = disc_conditional
    ...
    def forward(self, codebook_loss, inputs, reconstructions, optimizer_idx,
        ...
        nll_loss = torch.mean(nll_loss) # perceptual_loss + L1 loss
...
#
#            disc_factor = adopt_weight(self.disc_factor, global_step, threshold=self.discriminator_iter_start)
#            d_loss = 0 * self.disc_loss(logits_real, logits_fake) #d_loss = disc_factor * self.disc_loss(logits_real, logits_fake)
#
